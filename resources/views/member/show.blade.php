...
<div class="row">
      ...
      <tbody>
        @foreach($members as $member)
          <tr>
              <td class="text-center">{{ $member->member_mat_no }}</td>
             <td class="text-center" style="cursor: pointer;"  id="user_info_show" data-id="{{ $member->member_id }}" data-toggle="modal" data-target="#member_info_modal">
              <strong>{{ $member->member_name }}</strong> 
						 ...
						 <td class="text-center">{{ $member->member_fac }}</td>
              <td class="text-center">{{$member->member_dept}}</td>
              <td class="text-center">+234 - {{$member->member_contact}}</td>
